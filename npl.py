...
pl.clf()
pl.plot(np.sort(grRecall), np.sort(grPrecision)  , label='Precision-Recall curve')
pl.plot(np.sort(grRecall1), np.sort(grPrecision1), label='Precision1-Recall1 curve')
pl.plot(np.sort(grRecall2), np.sort(grPrecision2), label='Precision2-Recall2 curve')
pl.plot(np.sort(grRecall3), np.sort(grPrecision3), label='Precision3-Recall3 curve')
pl.plot(np.sort(grRecall4), np.sort(grPrecision4), label='Precision4-Recall4 curve')
pl.xlabel('Recall')
pl.ylabel('Precision')
